...
describe('CalendarService', () => {
  ...
  describe('isHijriLeapYear', () => {
    ...
    it('should work for years beyond first cycle', () => {
      // Test year 1446 (1446 % 30 = 16, which is a leap year)
      expect(calendarService.isHijriLeapYear(1446)).toBe(true);
      
      // Test year 1447 (1447 % 30 = 17, which is not a leap year)
      expect(calendarService.isHijriLeapYear(1447)).toBe(false);
      
      // Test year 1448 (1448 % 30 = 18, which is a leap year)
      expect(calendarService.isHijriLeapYear(1448)).toBe(true);
    });
  ...
  describe('getLunarYearAdjustment', () => {
    it('should return correct lunar year adjustment factor', () => {
      ...
      expect(adjustment).toBeCloseTo(0.9704, 4);
  ...
  describe('getCalendarInfo', () => {
    it('should return complete calendar calculation information', async () => {
      ...
      expect(calendarInfo.adjustmentFactor).toBeCloseTo(0.9704, 4);
    });
  ...
  describe('calculateZakatYearPeriod', () => {
    it('should calculate lunar year period correctly', () => {
      ...
      expect(result).toHaveProperty('calendarType');
  ...
  describe('Zakat calculation integration', () => {
    it('should provide correct adjustment factor for zakat calculations', async () => {
      ...
      expect(lunarAdjustment).toBeCloseTo(0.9704, 4);
