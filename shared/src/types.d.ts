...
export type AssetCategoryType = 'cash' | 'gold' | 'silver' | 'business' | 'property' | 'stocks' | 'crypto' | 'debts' | 'expenses';
...
export interface StocksAsset extends Asset {
    category: 'stocks';
    subCategory: 'individual_stocks' | 'mutual_funds' | 'etfs' | 'bonds' | 'index_funds' | 'retirement_401k' | 'retirement_ira' | 'retirement_other';
    ticker?: string;
    shares?: number;
...
export interface ExpensesAsset extends Asset {
    category: 'expenses';
    subCategory: 'debts_owed' | 'essential_needs' | 'family_obligations' | 'business_liabilities';
    creditor?: string;
    dueDate?: string;
    interestRate?: number;
    expenseType?: string;
...
export type SpecificAsset = CashAsset | GoldAsset | SilverAsset | BusinessAsset | PropertyAsset | StocksAsset | CryptoAsset | DebtAsset | ExpensesAsset;
