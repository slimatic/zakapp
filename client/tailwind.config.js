  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        // UpdateNotification drops in from the top; it referenced animate-slide-down
        // for its whole life while no such animation existed, so it appeared
        // statically. Defined here rather than pointing it at slide-up, which would
        // animate the wrong direction.
