...
export const UpdateNotification: React.FC = () => {
  ...
  return (
    <div className="fixed top-4 start-4 end-4 md:start-1/2 md:-translate-x-1/2 md:w-96 bg-secondary text-secondary-foreground rounded-lg shadow-elev-3 p-4 z-50 animate-slide-down">
