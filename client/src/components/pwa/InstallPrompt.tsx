...
export const InstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 start-4 end-4 md:left-auto md:end-4 md:w-96 bg-card/95 backdrop-blur-sm rounded-xl shadow-2xl border border-border p-5 z-50 animate-slide-up ring-1 ring-black/5">
      {/* Close button */}
      <button
        onClick={handleDismiss}
        className="absolute top-2 end-2 p-1.5 text-muted-foreground hover:text-foreground rounded-lg hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring transition-colors"
