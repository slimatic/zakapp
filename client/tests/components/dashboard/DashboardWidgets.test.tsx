...
import { ActiveRecordWidget } from '../../../src/components/dashboard/ActiveRecordWidget';
import { WealthSummaryCard } from '../../../src/components/dashboard/WealthSummaryCard';
import { OnboardingGuide } from '../../../src/components/dashboard/OnboardingGuide';
...
describe('Dashboard widgets', () => {
  ...
  describe('DashboardHeader', () => {
    it('encourages users without assets to add their first asset', () => {
      ...
      expect(screen.getByText(/add your assets/i)).toBeInTheDocument();
    });
